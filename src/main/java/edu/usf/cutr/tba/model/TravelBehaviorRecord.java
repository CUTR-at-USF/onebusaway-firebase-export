...
public class TravelBehaviorRecord {
    ...
    public static final String[] CSV_HEADER = {"User ID",
            ...
            "Origin Horizontal Accuracy (*best)",
            ...
            "Destination Horizontal Accuracy (*best)",
